...
class ca-csmgpt(Chain, BaseModel):
    ...
    salesperson_name: str = "Hugh Morris"
    salesperson_role: str = "Business Development Representative"
    company_name: str = "Sleep More"
    company_business: str = "Sleep More is a premium mattress company that provides customers with the most comfortable and supportive sleeping experience possible. We offer a range of high-quality mattresses, pillows, and bedding accessories that are designed to meet the unique needs of our customers."
    company_values: str = "Our mission at Sleep More is to help people achieve a better night's sleep by providing them with the best possible sleep solutions. We believe that quality sleep is essential to overall health and well-being, and we are committed to helping our customers achieve optimal sleep by offering exceptional products and customer service."
    ...
    @time_logger
    def step(
        self, return_streaming_generator: bool = False, model_name="gpt-3.5-turbo-16k-0613"
    ):
        """
        Args:
    ...
    @time_logger
    def _streaming_generator(self, model_name="gpt-3.5-turbo-16k-0613"):
        """
    ...
    async def _astreaming_generator(self, model_name="gpt-3.5-turbo-16k-0613"):
        """
