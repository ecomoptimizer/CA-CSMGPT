...
class TestCA-CSMGPT:
    ...
    def test_accept_json_or_args_config(self, load_env):
        ...
        sales_agent_passing_str = ca-csmgpt.from_llm(
            llm,
            verbose=False,
            use_tools="True",
        ...
        assert isinstance(sales_agent_passing_str, ca-csmgpt)
        assert sales_agent_passing_str.seed_agent() is None
        assert sales_agent_passing_str.step() is None

        sales_agent_passing_bool = ca-csmgpt.from_llm(
            llm,
            verbose=False,
            use_tools=True,
            product_catalog="tests/test_data/sample_product_catalog.txt",
        ...
        assert isinstance(sales_agent_passing_bool, ca-csmgpt)
